...
จากผลที่ได้ พบว่า
- **bit depth (presition)** อยู่ที่ 24 bit ต้องทำการลด bit rate ให้อยู่ที่ 16 bit ก่อน เนื่องจาก SIGNSTEK Q5 รองรับ bit rate สูงสุดที่ 16 bit
- **sample rate** อยู๋ที่ 48000 Hz ไม่ต้องทำการลด sample rate
...
ก่อนทำการทดลองเราจะมาทำการทดสอบความถูกต้องของวิธีการทดลอง โดยใช้ไฟล์ต้นฉบับเปรียบเทียบกับ
- **ไฟล์ต้นฉบับเอง** เสมือนเสาย USB ไม่มีผลต่อเสียงที่ได้
- **ไฟล์ที่ปรับเสียงให้ต่างจากต้นฉบับ** เสมือนเสาย USB มีผลต่อเสียงที่ได้
