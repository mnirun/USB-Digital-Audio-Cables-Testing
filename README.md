# USB Digital Audio Cables Testing

- [วัตถุประสงค์](#วัตถุประสงค์)
- [หลักของการทดลอง](#หลักของการทดลอง)
...
- [การทดลอง สาย USB มีผลต่อเสียงที่ได้หรือไม่](#การทดลอง-สาย-usb-มีผลต่อเสียงที่ได้หรือไม่-)
    ...
    - [สรุปผลการทดสอบความถูกต้องของวิธีการทดลอง](#สรุปผลการทดสอบความถูกต้องของวิธีการทดลอง)
    - [ขั้นตอนการทดลองสาย USB](#ขั้นตอนการทดลองสาย-usb)
    - [ผลการทดลองสาย USB ทั้ง 15 เส้น](#ผลการทดลองสาย-usb-ทั้ง-15-เส้น)
- [สรุปผลการทดลอง](#สรุปผลการทดลอง)

## วัตถุประสงค์

- เพื่ออธิบายถึงหลักการทำงานของ USB Digital Audio เบื้องต้น โดยพยายามใข้การอธิบายที่เข้าใจง่าย แต่อาจไม่ได้ลงลึกในเชิงเทคนิคมากนัก
- เพื่อทำการทดลองทางวิทยาศาสตร์ว่าสาย USB มีผลต่อเสียงหรือไม่ เน้นการทดลองที่สามารถทำตามได้ อธิบายวิธีการทดลองในทุกขั้นตอน และตรวจสอบการทดลองดัวยข้อมูลที่เป็นตัวอักษรและตัวเลขเท่านั้น ไม่ใช้การตรวจสอบข้อมูลด้วยการดูกราฟหรือฟังเสียงแต่อย่างใด (กราฟมีไว้เพื่อประกอบการทดลองให้เห็นภาพเท่านั้น)

## หลักของการทดลอง

- การทดลองทั้งหมดจะทำในระบบดิจิทัลผ่าน DDC (Digital to Digital Converter) เท่านั้น ไม่มีการแปลงข้อมูลเป็นอนาล็อกผ่าน DAC (Digital to Analog Conveter) แต่อย่างใด
...
|[:computer: FFmpeg](https://www.ffmpeg.org/)|[:floppy_disk: 4.4](https://www.gyan.dev/ffmpeg/builds/)|ตรวจหาเสียงเงียบของไฟล์เสียง|
...
- **ตรวจสอบข้อมูลบิตต่อบิต** หากไฟล์ทั้ง 2 ไฟล์เหมือนกันทุกบิตจะเรียกว่า 100% Bit-Perfect โดยเราจะตรวจสอบด้วยโปรแกรม DeltaWave ซึ่งเป็นโปรแกรมสำหรับเปรียบเทียบไฟล์เสียงโดยเฉพาะ
...
##### ตรวจสอบข้อมูลบิตต่อบิต

ตรวจสอบข้อมูลบิตต่อบิตด้วยโปรแกรม DeltaWave

 - **ไฟล์ต้นฉบับเอง** 100% Bit Perfect

    ![deltawave_01](pictures/deltawave_01.png)

 - **ไฟล์ที่ปรับเสียงให้ต่างจากต้นฉบับ** ไม่ใช่ Bit Perfect

    ![deltawave_02](pictures/deltawave_02.png)

##### ตรวจสอบโดยการกลับเฟสเสียง

ทำการกลับเฟสเสียงไฟล์ต้นฉบับเทียบกับไฟล์ตัวอย่างทั้ง 2 ไฟล์ด้วยโปรแกรม SoX แล้วบันทึกเป็นไฟล์ใหม่โดยใช้คำสั่ง
...
จากนั้นทำการตรวจหาระยะเวลาเสียบเงียบทั้งหมดของไฟล์ด้วยโปรแกรม FFmpeg โดยใช้คำสั่ง

> ffmpeg -hide_banner -i master_16_48_pad_inverted.wav -af silencedetect=n=-90dB -f null -

> ffmpeg -hide_banner -i master_16_48_pad_eq_3000_inverted.wav -af silencedetect=n=-90dB -f null -

จากการตรวจหาระยะเวลาเสียบเงียบทั้งหมดของไฟล์ด้วยโปรแกรม FFmpeg พบว่า

- **ไฟล์ต้นฉบับเอง** เสียงจะเงียบตั้งแต่วินาทีที่ 0 จนจบไฟล์

    ![ffmpeg_silencedetect](pictures/ffmpeg_silencedetect.png)

- **ไฟล์ที่ปรับเสียงให้ต่างจากต้นฉบับ** เสียงจะไม่ได้เงียบตลอดทั้งไฟล์ จะเงียบแค่
    - **ช่วงต้นไฟล์** เริ่มตั้งแต่วินาทีที่ 0 ถึงวินาที่ที่ 2.00135
    - **ช่วงท้ายไฟล์** เริ่มตั้งแต่วินาทีที่ 221.008 ถึงวินาที่ที่ 223.008

    ![ffmpeg_silencedetect_eq_3000](pictures/ffmpeg_silencedetect_eq_3000.png)

ทำการสร้างกราฟ spectrogram ด้วยโปรแกรม SoX โดยใช้คำสั่ง
...
![sox_spectrogram_inverted](pictures/sox_spectrogram_inverted.png)
...
![sox_spectrogram_inverted_3000](pictures/sox_spectrogram_inverted_3000.png)

จากการสร้างกราฟ spectrogram ด้วยโปรแกรม SoX พบว่า

- **ไฟล์ต้นฉบับเอง** เสียงจะเงียบตั้งแต่วินาทีที่ 0 จนจบไฟล์ ไม่มีภาพความถี่ใด ๆ ในกราฟ spectrogram

    ![sox_master_16_48_pad_inverted_spectrogram](pictures/sox_master_16_48_pad_inverted_spectrogram.png)

- **ไฟล์ที่ปรับเสียงให้ต่างจากต้นฉบับ** เสียงจะไม่ได้เงียบตลอดทั้งไฟล์ จะมีภาพความถี่ปรากฎในกราฟ spectrogram

    ![sox_master_16_48_pad_eq_3000_inverted](pictures/sox_master_16_48_pad_eq_3000_inverted.png)

### สรุปผลการทดสอบความถูกต้องของวิธีการทดลอง

จากการทดสอบความถูกต้องของวิธีการทดลอง หากไฟล์เสียงเหมือนต้นฉบับ จะต้อง

- 100 % Bit Perfect
- เมื่อกลับเฟสแล้ว
    - เสียงจะเงียบตลอดไฟล์
    - กราฟ Spectrogram จะไม่มีภาพความถี่ใด ๆ ในกราฟ

|ไฟล์|เทียบ Bit Perfect กับต้นฉบับ|กลับเฟส เสียงเงียบตลอดไฟล์|กราฟ Spectrogram กลับเฟส|
|-|-|-|-|
