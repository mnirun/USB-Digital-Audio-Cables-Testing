...
- เพื่ออธิบายถึงหลักการทำงานของ USB Digital Audio เบื้องต้น พยายามใข้การอธิบายที่เข้าใจง่าย อาจไม่ได้ลงลึกในเชิงเทคนิคมากนัก
- ทำการทดลองในรูปแบบวิทยาศาสตร์ที่ทุกท่านสามารถทำตามได้ เน้นการอธิบายวิธีการทดลองในทุกขั้นตอน และตรวจสอบการทดลองดัวยข้อมูลที่เป็นตัวอักษรและตัวเลขเท่านั้น ไม่ใช้ตรวจสอบข้อมูลด้วยการใข้สายตาหรือการใช้หูฟังเสียง
